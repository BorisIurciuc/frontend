    ...
    return (
        <div className = {style.cityClass}>
            ...
            <div>
                ...
                <img src="https://de.cosmoconsult.com/fileadmin/user_upload/Deutschland/Header_Visual/cosmo-consult-locations-germany-wuerzburg.webp" alt="" />
            </div>
            <div>
                <p>
                ...
                <img src="https://www.merian.de/uploads/media/1920x1080/00/5970-Wu%CC%88rzburg-Mainufer.webp?v=1-0" alt="" />
            </div>

        </div>
    )
}
export default Wurzburg;